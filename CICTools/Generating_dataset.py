...
if __name__ == '__main__':
    ...
    pcapfiles = [
        "C:\\Users\\Thesis\\Downloads\\DDoS-HTTP_Flood\\DDoS-HTTP_Flood\\DDoS-HTTP_Flood\\DDoS-HTTP_Flood.pcap"
]
    subfiles_size = 10 # MB
    ...
    for i in range(len(pcapfiles)):
        ...
        os.system('C:\\Users\\Thesis\\Downloads\\tcpdump_trial_license\\tcpdump.exe -r '+ pcap_file +' -w ' + split_directory + 'split_temp -C ' + str(subfiles_size))
